...
const SEED_BOOKS = [
  { isbn:"978-0-262-03384-8", title:"Introduction to Algorithms",
    ...
    shelfLocation:"CS-A1-001", totalCopies:12, availableCopies:7, borrowCount:145, coverColor:"#6D28D9", status:"available" },
  { isbn:"978-0-393-88443-0", title:"Molecular Biology of the Cell",
    ...
    shelfLocation:"BIO-B2-014", totalCopies:8, availableCopies:2, borrowCount:98, coverColor:"#059669", status:"low-stock" },
  { isbn:"978-0-357-72210-3", title:"Principles of Economics",
    ...
    shelfLocation:"ECO-C1-007", totalCopies:15, availableCopies:0, borrowCount:201, coverColor:"#D97706", status:"checked-out" },
  { isbn:"978-1-285-74155-0", title:"Calculus: Early Transcendentals",
    ...
    shelfLocation:"MAT-A3-022", totalCopies:20, availableCopies:14, borrowCount:178, coverColor:"#2563EB", status:"available" },
  { isbn:"978-0-470-92765-0", title:"Organic Chemistry",
    ...
    shelfLocation:"CHE-D2-008", totalCopies:10, availableCopies:3, borrowCount:122, coverColor:"#0891B2", status:"low-stock" },
  { isbn:"978-1-119-46049-7", title:"Fundamentals of Physics",
    ...
    shelfLocation:"PHY-B1-003", totalCopies:10, availableCopies:6, borrowCount:87, coverColor:"#7C3AED", status:"available" },
  { isbn:"978-0-7020-7504-4", title:"Medical Physiology",
    ...
    shelfLocation:"MED-E1-019", totalCopies:6, availableCopies:0, borrowCount:64, coverColor:"#DC2626", status:"checked-out" },
  { isbn:"978-0-521-63306-9", title:"A History of Western Philosophy",
    ...
    shelfLocation:"PHI-F3-002", totalCopies:5, availableCopies:4, borrowCount:43, coverColor:"#DB2777", status:"available" },
  { isbn:"978-0-521-67444-4", title:"The Cambridge History of the English Language",
    ...
    shelfLocation:"LIT-G2-011", totalCopies:4, availableCopies:4, borrowCount:28, coverColor:"#BE123C", status:"available" },
  { isbn:"978-0-470-64818-0", title:"Quantitative Chemical Analysis",
    ...
    shelfLocation:"CHE-D1-005", totalCopies:7, availableCopies:0, borrowCount:91, coverColor:"#0D9488", status:"checked-out" },
];
